"""
repository.py — Reference-data access layer for GetAvgProcCostForecast Service (v2).

Mirrors the KNN Quote Service Production repository interface so both
services can share the same underlying database.

Required DB tables
------------------
  transactions   : transaction_id, date, amount, merchant_id, mcc,
...
class MerchantRepository(Protocol):
    """Interface that every repository implementation must satisfy."""
...
# ---------------------------------------------------------------------------
# SQLite implementation (local file)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# SQLAlchemy implementation (PostgreSQL, MySQL, MSSQL, etc.)
# ---------------------------------------------------------------------------

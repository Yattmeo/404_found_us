...
interface LandingPageProps {
  onNavigate: (page: 'current-rates' | 'desired-margin') => void;
}
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-orange-100 flex items-center justify-center p-8">
      <div className="max-w-5xl w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Current Rates Card */}
          <div className="bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden group cursor-pointer" onClick={() => onNavigate('current-rates')}>
            {/* Image with overlay */}
          ...
          {/* Desired Margin Card */}
          <div className="bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden group cursor-pointer" onClick={() => onNavigate('desired-margin')}>
            {/* Image with overlay */}
            <div className="relative h-56 overflow-hidden">
              <img 

...
OUTPUT_FILE = os.path.join(SCRIPT_DIR, "merch_003_transactions.csv")
...
# --- MERCHANT PROFILE ---
# "The General Store" (MERCH_003): Standard spread ($20 - $100).
...
merchant = {
    ...
    "min": 20.00,
    "max": 150.00,
    "cards": ["Debit", "Credit", "Debit (Prepaid)"]
}
...
edge_cases = [
    ...
    {"transaction_id": generate_txn_id(), "merchant_id": merchant["id"], "date": "2025-01-15 12:00:00", "amount": -50.00, "card_type": "Credit", "card_brand": "Visa", "transaction_type": "Offline"},
]

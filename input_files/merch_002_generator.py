...
OUTPUT_FILE = os.path.join(SCRIPT_DIR, "merch_002_transactions.csv")
...
# --- MERCHANT PROFILE ---
# "The Luxury Boutique" (MERCH_002): Low volume, huge amounts ($500 - $5000).
...
edge_cases = [
    ...
    {"transaction_id": generate_txn_id(), "merchant_id": merchant["id"], "date": "2025-01-15 10:00:00", "amount": 0.00, "card_type": "Credit", "card_brand": "Visa", "transaction_type": "Online"},
    # The "Negative" refund (Should not add to cost volume)
    {"transaction_id": generate_txn_id(), "merchant_id": merchant["id"], "date": "2025-01-15 12:00:00", "amount": -1000.00, "card_type": "Credit", "card_brand": "Amex", "transaction_type": "Offline"},
]
